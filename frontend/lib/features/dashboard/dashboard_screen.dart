...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _openAddPoolForm({bool isEdit = false}) {
    Navigator.of(context).push(
      PageRouteBuilder(
        pageBuilder: (_, animation, __) => AddPoolScreen(
          onSave: _savePool,
          initialData: (isEdit && _selectedPool != null) ? PoolData(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () => _openAddPoolForm(isEdit: false),
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // Grupo de acciones estratégicas
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        if (_pools.length < 3)
                        ...
                        IconButton(
                          ...
                          icon: const Icon(Icons.delete_outline_rounded, color: AppColors.statusDanger, size: 24),
                          tooltip: 'Eliminar piscina',
                          style: IconButton.styleFrom(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 4),
                  Text(
                    widget.initialData != null ? 'Editar piscina' : 'Nueva piscina',
                    style: GoogleFonts.syne(
                      color: AppColors.textPrimary,
                      fontSize: 20,
                      fontWeight: FontWeight.w700,
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: _isSaving
                            ...
                            : Text(
                                widget.initialData != null ? 'Guardar cambios' : 'Agregar piscina',
