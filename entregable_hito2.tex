...
Incluir capturas de pantalla o descripciones de las funcionalidades clave en el entorno de producción. Las capturas correspondientes están adjuntas a continuación.
\end{infobox}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{capturas/captura_evidencia_func_01.png}
  \caption{Evidencia de funcionamiento: captura 01.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{capturas/captura_evidencia_func_02.png}
  \caption{Evidencia de funcionamiento: captura 02.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{capturas/captura_evidencia_func_03.png}
  \caption{Evidencia de funcionamiento: captura 03.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{capturas/captura_evidencia_func_04.png}
  \caption{Evidencia de funcionamiento: captura 04.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{capturas/captura_evidencia_func_05.png}
  \caption{Evidencia de funcionamiento: captura 05.}
\end{figure}
...
\vspace{0.3em}
Flujo:(1) registro/inicio de sesión, (2) creación/selección de piscina, (3) revisión de estado actual y métricas, (4) ejecución de tratamiento manual, (5) validación de historial de mantenciones y (6) Visualización de temperatura en la app.
